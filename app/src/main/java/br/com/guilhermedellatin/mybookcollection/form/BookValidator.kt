...
class BookValidator {
    ...
    private fun checkName(name: String) = name.length in 2..60
    private fun checkGender(gender: String) = gender.length in 2..60
    private fun checkPublishing(publishing: String) = publishing.length in 2..60
}